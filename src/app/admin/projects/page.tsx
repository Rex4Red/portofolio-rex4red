...
import { getProjects, addProject, deleteProject, Project } from "@/lib/data";
  ...
  return (
    <AdminShell>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {data.map((p) => (
            <div key={p.id} className="bg-surface-elevated bento-card rounded-xl p-5 flex flex-col md:flex-row md:items-center gap-4 hover:border-border-hover transition-all">
              ...
              <div className="flex items-center gap-2 shrink-0">
                <button className="w-8 h-8 rounded-lg bg-surface-2 flex items-center justify-center text-text-secondary hover:text-primary hover:bg-accent-subtle transition-all" title="Edit">
